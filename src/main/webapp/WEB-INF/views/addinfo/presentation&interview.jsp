...
<%@include file="./../include/main_header.jsp"%>
	...
	<div class="container_body">
		...
		<h2 style="text-align:center">※발표 시 알아야 할 중요사항※</h2><br>				
		...
		<iframe width="420" height="345" src="https://youtu.be/s5-Psu7UgOo">
		</iframe>
		...
		3.발표 잘하는 사람 흉내내기<br><br>
		말을 잘하는 자신의 모습을 상상해보거나, 말을 잘하는 사람을 따라합니다.<br> 
		많은 청중앞에서 연습한다고 생각하고 합니다.<br>
