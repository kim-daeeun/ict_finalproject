...
<body style="height:1020px" onload="startGame()">
				...
				<div class="panel panel-danger">
					...
					<div class="panel-heading">
						<h3 class="panel-title">
							...
							&nbsp;관련기업
							<a href="lecture.html?lectureName=c" class="pull-right">more</a>
						</h3>
					</div>
					...
					<table class="table">
						...
						<tr>
							<td>삼성</td>
							<td>광주</td>
							<td><a href="lecture.html?lectureName=c">개발 및 유지보수</a></td>

						</tr>
						<tr>
							<td>LG</td>
							<td>광주</td>
							<td><a href="lecture.html?lectureName=java">java 개발</a></td>

						</tr>
						<tr>
							<td>한전</td>
							<td>나주</td>
							<td><a href="lecture.html?lectureName=android">소프트웨어 개발</a></td>
