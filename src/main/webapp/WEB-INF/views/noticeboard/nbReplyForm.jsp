...
<%@include file="./../include/main_header.jsp"%>
	...
	<div class="container_body">
		...
		<h2 style="text-align:center">답글쓰기</h2>					
		
			 
<!-- 		<div class="test01 col-md-push-2 col-md-8 "> -->
		
		
		<!-- <form action="nbReply.ict" method="post" enctype="multipart/form-data"> -->
		<form:form action="nbReply.ict" method="post">
			...
			<table class="table table-bordered">  
				...
				<tr>
				 ...
				 <td class="rightside"><input type="text" name="title" value="[Re]" id="reply_title"></td>			 
				</tr>
				<tr>
				  <td colspan="2">
				  <textarea cols="90" rows="20" name="content"  id="reply_content" ></textarea>
				  </td>
			    </tr> 	
...
<!-- 			        
			    <tr>
			      <td>파일첨부  </td>
			      <td><input type="file"  class='fileDrop' name="fname"  multiple="multiple"></td>
			    </tr>
...
<!-- 		  			<button type="button" class="btn btn-primary" onClick="ajaxFileUpload()" id="qnaUpdate_file"> 파일 업로드 </button> -->
		  			<button type="button" class="btn btn-danger" id="qnaUpdate_delete"> 파일 모두삭제</button>
					<button type="submit" class="btn btn-primary"> 답글쓰기 </button> 
					<button type="reset" class="btn btn-warning"> 답글쓰기 취소</button>
					</td>
				</tr> 	
