...
#faqreply_write, #faqreply_back{
	margin: 0 auto;
	width:200px;
}

#faqreply_file, #faqreply_delete{
	margin: 0 auto;
	width:200px;
}
...
<%@include file="./../include/main_header.jsp"%>
	...
	<form action="/ictinfo/faqreply.ict" method="post" enctype="multipart/form-data">
	...
	<table border="2" width="800" align="center">
		<tr>
 		...
 		<tr>	 
		 <td><input type="text" name="title" value="[Re]" class="form-control"></td>			 
		</tr>
		<tr>
		  <td colspan="2">
	    ...
	    <tr>
	      <td colspan="2">
		  	<div class="faqreply_btn" height="40px">
		  		<div class="filebox">
		  			<br>
		  			...
		  			value="파일 업로드" id="faqreply_file"/>
		  			<input type="button" value="파일 모두삭제" class="btn btn-danger" id="faqreply_delete">
		  		</div><br>
		  	</div>
		  </td>
	    </tr>
	    <tr>
	      <td><br><div class='fileDrop'></div>
				...
				<div class="faqreply_btn">
		      		<input type="submit" value="답글쓰기" class="btn btn-success" id="faqreply_write">
		      		<input type="reset" value="처음으로" class="btn btn-info" id="faqreply_back"
...
$("#faqreply_delete").on("click", function(event){			
	let files=[];
